...
describe ApiGatewayV2AccessLoggingRule do
  context 'Api Gateway V2 has no access logging configured since it missing stagedescription' do
    it 'returns offending logical resource id' do
      cfn_model = CfnParser.new.parse read_test_template('json/apigateway_accesslogging_v2/apigateway_with_no_access_logging_missing_stagedescription.json')
  ...
  context 'Api Gateway V2 should has access logging configured' do
    it 'returns empty' do
