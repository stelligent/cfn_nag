...
password_property = 'MemberConfiguration'
sub_property_name = 'MemberFrameworkConfiguration'
sub_sub_property_name = 'MemberFabricConfiguration'
sub_sub_sub_property_name = 'AdminPassword'
...
describe Object.const_get(rule_name(resource_type, password_property, sub_property_name, sub_sub_property_name, sub_sub_sub_property_name)), :rule do
  ...
  password_rule_test_sets.each do |test_description, desired_test_result|
    context "#{resource_type} #{password_property} #{sub_property_name} #{sub_sub_property_name} #{sub_sub_sub_property_name} #{test_description}" do
