...
describe ElastiCacheReplicationGroupTransitEncryptionRule do
  context 'Replication Group without encryption' do
    it 'returns offending logical resource id' do
      ...
      actual_logical_resource_ids = ElastiCacheReplicationGroupTransitEncryptionRule.new.audit_impl cfn_model
